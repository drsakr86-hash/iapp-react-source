...
export function GlassesPrescriptionReport({
  data,
  lang = 'ar',
  recipient,
}: {
  ...
  if (!data.glasses.length) return null;
  return (
    <article className="medical-report print-glasses" dir={dirFor(lang)}>
      <ReportHeader
        data={data}
        lang={lang}
        recipient={recipient}
        docType="glasses"
        documentTitle={label(RL.glassesDocTitle, lang)}
      />
      <GlassesSection items={data.glasses} lang={lang} />
